...
('Amelia S. Harris',	29,	'nec.metus.facilisis@vitaealiquet.edu',	'4S64Y3A'),
...
update usuarios set data_nascimento = '1991-09-29'::date where email = 'auctor@duiFuscediam.edu';

update usuarios set data_nascimento = '1988-11-02'::date where email = 'nec.metus.facilisis@vitaealiquet.edu';
...
('Tate I. Dean',	'1989-05-01'::date,	'Nunc@etmagnis.edu',	'd3V25D6Y'),
('Arsenio K. Harmon',	'1985-10-23'::date,	'adipiscing.elit@turpis.com',	'm3T58S0C');